...
class Mundial:
    ...
    def generar_equipos_aleatorios(self):
        ...
        for nombre_equipo in nombres_equipos:
            ...
            for _ in range(random.randint(18, 23)):  # Entre 18 y 23 jugadores por equipo
...
class MundialApp:
    def __init__(self, root):
        ...
        # Generar equipos y estadios aleatorios
        ...
        for grupo in self.mundial.grupos:
            for otro_equipo in grupo.equipos:
                if otro_equipo.nombre != equipo_seleccionado:
                    ...
                    resultado_partido = random.choice(["2-1", "1-3", "0-0", "3-2"])  # Resultado aleatorio simulado
